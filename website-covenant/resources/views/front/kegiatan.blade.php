  ...
  <div class="w-screen font-Kanit">
    ...
    <div class="flex flex-col items-center mt-24 mb-24 mx-5 sm:px-14 md:px-11 lg:px-11 xl:px-20">
        ...
        <div class=" grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 place-items-center lg:gap-1">
          ...
          {{-- AREA CARD --}}
          <a href="detailKegiatan" class="rounded-b-xl group w-full lg:w-10/12 xl:w-10/12 transform hover:group-hover:bg-black-opacity-2 transition duration-500 hover:scale-105 relative">
            {{-- AREA HOVER --}}
            ...
            {{-- IMAGE --}}
            <img class="rounded-xl w-full h-full" src="{{ asset('storage/local_images/3.jpg') }}" alt="">
          </a>
