...
<div class="text-center font-kanit mt-20">
  ...
  <section class="bg-white">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      <div class="grid grid-cols-1 gap-4 mt-8">
        <img class="w-full rounded-lg" src="{{ asset('storage/images/gambar-pertama.png') }}" alt="Logo" style="max-width: 400px; /* set your desired max width */">
      </div>
  ...
  <section class="bg-white">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      ...
      <div class="grid grid-cols-1 gap-4 mt-8">
        <img class="w-full rounded-lg" src="{{ asset('storage/images/gambar-kedua.png') }}" alt="Logo" style="max-width: 840px; /* set your desired max width */">
      </div>
    </div>
  </section>
  ...
  <section class="bg-white">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      <div class="grid grid-cols-1 gap-4 mt-8">
        <img class="w-full rounded-lg" src="{{ asset('storage/images/gambar-ketiga.png') }}" alt="Logo" style="max-width: 840px; /* set your desired max width */">
      </div>
      <div class=" text-gray-500 sm:text-lg dark:text-gray-400">
  ...
  <section class="bg-white">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      ...
      <div class="grid grid-cols-1 gap-4 mt-8">
        <img class="w-full rounded-lg" src="{{ asset('storage/images/gambar-keempat.png') }}" alt="Logo" style="max-width: 840px; /* set your desired max width */">
      </div>
    </div>
  </section>
